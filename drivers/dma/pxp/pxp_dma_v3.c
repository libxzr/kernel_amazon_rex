...
static __attribute__((aligned (1024*4))) unsigned int bit1_dither_data_16x16[256]={
1,  129/2,   33/2,  161/2,    9/2,  137/2,   41/2,  169/2,    4/2,  132/2,   36/2,  164/2,   12/2,  140/2,   44/2,  172/2,
193/2,   65/2,  225/2,   97/2,  201/2,   73/2,  233/2,  105/2,  196/2,   68/2,  228/2,  100/2,  204/2,   76/2,  236/2,  108/2,
49/2,  177/2,   17/2,  145/2,   57/2,  185/2,   25/2,  153/2,   52/2,  180/2,   20/2,  148/2,   60/2,  188/2,   28/2,  156/2,
241/2,  113/2,  209/2,   81/2,  249/2,  121/2,  217/2,   89/2,  244/2,  116/2,  212/2,   84/2,  252/2,  124/2,  220/2,   92/2,
13/2,  141/2,   45/2,  173/2,    5/2,  133/2,   37/2,  165/2,   16/2,  144/2,   48/2,  176/2,    8/2,  136/2,   40/2,  168/2,
205/2,   77/2,  237/2,  109/2,  197/2,   69/2,  229/2,  101/2,  208/2,   80/2,  240/2,  112/2,  200/2,   72/2,  232/2,  104/2,
61/2,  189/2,   29/2,  157/2,   53/2,  181/2,   21/2,  149/2,   64/2,  192/2,   32/2,  160/2,   56/2,  184/2,   24/2,  152/2,
253/2,  125/2,  221/2,   93/2,  245/2,  117/2,  213/2,   85/2,  256/2,  128/2,  224/2,   96/2,  248/2,  120/2,  216/2,   88/2,
3/2,  131/2,   35/2,  163/2,   11/2,  139/2,   43/2,  171/2,    2/2,  130/2,   34/2,  162/2,   10/2,  138/2,   42/2,  170/2,
195/2,   67/2,  227/2,   99/2,  203/2,   75/2,  235/2,  107/2,  194/2,   66/2,  226/2,   98/2,  202/2,   74/2,  234/2,  106/2,
51/2,  179/2,   19/2,  147/2,   59/2,  187/2,   27/2,  155/2,   50/2,  178/2,   18/2,  146/2,   58/2,  186/2,   26/2,  154/2,
243/2,  115/2,  211/2,   83/2,  251/2,  123/2,  219/2,   91/2,  242/2,  114/2,  210/2,   82/2,  250/2,  122/2,  218/2,   90/2,
15/2,  143/2,   47/2,  175/2,    7/2,  135/2,   39/2,  167/2,   14/2,  142/2,   46/2,  174/2,    6/2,  134/2,   38/2,  166/2,
207/2,   79/2,  239/2,  111/2,  199/2,   71/2,  231/2,  103/2,  206/2,   78/2,  238/2,  110/2,  198/2,   70/2,  230/2,  102/2,
63/2,  191/2,   31/2,  159/2,   55/2,  183/2,   23/2,  151/2,   62/2,  190/2,   30/2,  158/2,   54/2,  182/2,   22/2,  150/2,
255/2,  127/2,  223/2,   95/2,  247/2,  119/2,  215/2,   87/2,  254/2,  126/2,  222/2,   94/2,  246/2,  118/2,  214/2,   86/2
};
...
static int pxp_set_scaling(struct pxps *pxp)
{
	...
	u32 downscaling_bypass_decimation = 0;
	...
	if (!proc_data->drect.width || !proc_data->drect.height) {
		pr_err("Invalid drect width and height passed in  w=%d h=%d\n",proc_data->drect.width,proc_data->drect.height);
		return -EINVAL;
	}
	...
	if (decx > 2) {
		...
		xscale = proc_data->srect.width * 0x1000 /
			 (proc_data->drect.width * decx);
               ...
               if (decx>1)
                  downscaling_bypass_decimation = 1;
	} else {
	...
	/*
	 * The X and Y offset provides the ability to access the source image
	 * with a per sub-pixel granularity.
	 * If a fixed offset of 0x800 (1/2), all pixels are used in scaling the
	 * final output pixel value. In this case, the first output pixel
	 * would be the sum of (1/2*P0) + (1/2*P1).
	 */
	__raw_writel(s0scale, pxp->base + HW_PXP_PS_SCALE);
	if (downscaling_bypass_decimation == 1)
               __raw_writel(0x08000800, pxp->base + HW_PXP_PS_OFFSET);
...
static void pxp_set_final_lut_data(struct pxps *pxp)
{
	...
	if(proc_data->quant_bit < 2) {
		pxp_sram_init(pxp, DITHER0_LUT, (u32)bit1_dither_data_16x16, 256);
		__raw_writel(
...
static void pxp_dithering_process(struct pxps *pxp)
{
			...
			pxp->base + HW_PXP_INIT_MEM_CTRL);
	{
		...
		for (i = 0; i < 256; i++)
			__raw_writel(
					BF_PXP_INIT_MEM_DATA_DATA(bit1_dither_data_16x16[i]),
					pxp->base + HW_PXP_INIT_MEM_DATA);
	}
	...
	if (pxp_is_v3(pxp))
		val = BF_PXP_DITHER_CTRL_ENABLE0            (1) |
		      ...
		      BF_PXP_DITHER_CTRL_IDX_MATRIX0_SIZE   (2) |
...
static void pxp_dithering_configure_v3p(struct pxps *pxp)
{
	...
	__raw_writel(BF_PXP_CTRL_BLOCK_SIZE(BV_PXP_CTRL_BLOCK_SIZE__16X16) |
