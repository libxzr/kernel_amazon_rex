...
#define NSC_SSIDLIST_FIXED_SIZE	(OFFSETOF(nsc_ssid_list_t, ssid_entry))
...
#define NSC_SCPATT_MAX_ENTRIES	500
/* scan pattern array */
typedef struct scpatt {
	uint32 num_entries;
	uint8 scan_pattern[1];
} nsc_scpatt_t;

#define SCPATT_FIXED_SIZE 	(OFFSETOF(nsc_scpatt_t, scan_pattern))
...
#define NSC_SCANDES_FIXED_SIZE	(OFFSETOF(nsc_scandes_t, sdlist))
...
/* max street pass mac list entries */
#define NSC_MAX_SPMAC	256
