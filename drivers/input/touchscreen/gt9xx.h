...
#define GTP_AUTO_UPDATE_FORCE  0    // force auto update fw by .bin file as default, function together with GTP_AUTO_UPDATE
#define GTP_AUTO_UPDATE_CFG_FORCE 0    // force auto update config by .cfg file, function together with GTP_AUTO_UPDATE_CFG
