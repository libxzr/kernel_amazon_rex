...
#if defined(CONFIG_LAB126) && defined(CONFIG_HIBERNATION_IMX6SLL)
extern void imx6sll_hibernation_init(void);
#endif
	...
	if (cpu_is_imx6sll()) {
		...
		if (!IS_ERR(gpr))
			...
			regmap_update_bits(gpr, IOMUXC_GPR5,
				IOMUXC_GPR5_CLOCK_AFCG_X_BYPASS_MASK, IOMUXC_GPR5_CLOCK_AFCG_X_BYPASS_MASK);
#else
			regmap_update_bits(gpr, IOMUXC_GPR5,
